            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="bg-kategori">
                        ...
                        <a class="section-title-kategori" href="/category/{category}">{{$product_category}}</a>
                    </div>
                </div>
                            ...
                            @foreach ($categories ->take(4) as $category)
                                    ...
                                    <div class="col-md-4" style="width: 25rem; height: 25rem;">
                                        <div class="best-seller-box">
                                            ...
                                            <a href="{{url('produk')}}/{{$category->product_id}}"><img class="pic-product" src="{{url('assets/image/product')}}/{{$category->product_image}}"></a>
                                        <div>
                                    </div>
                            @endforeach      
                        </div>
